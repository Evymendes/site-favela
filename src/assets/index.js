...
export { default as CompleteLogo } from './completeLogo.jpg';
...
//Icons
export { default as Face } from './icons/facebook.png';
export { default as Instagram } from './icons/instagram.png';

// Photo Prazeres
export { default as ApresentandoOProgramaUm } from './programLaunch/prazeres/ApresentandoOPrograma(1).JPG';
export { default as ApresentandoOProgramaDois } from './programLaunch/prazeres/ApresentandoOPrograma(2).JPG';
export { default as ApresentandoOProgramaTres } from './programLaunch/prazeres/ApresentandoOPrograma(3).jpeg';
export { default as ApresentandoOProgramaQuatro } from './programLaunch/prazeres/ApresentandoOPrograma(4).jpeg';
export { default as ApresentandoOProgramaCinco } from './programLaunch/prazeres/ApresentandoOPrograma(5).JPG';
export { default as ApresentandoOProgramaSeis } from './programLaunch/prazeres/ApresentandoOPrograma(6).jpeg';
export { default as ApresentandoOProgramaSete } from './programLaunch/prazeres/ApresentandoOPrograma(7).jpeg';
export { default as ApresentandoOProgramaOito } from './programLaunch/prazeres/ApresentandoOPrograma(8).jpeg';
export { default as ApresentandoOProgramaNove } from './programLaunch/prazeres/ApresentandoOPrograma(9).jpeg';

export { default as MarcosBandeiraDancarinoeCoreografoUm } from './programLaunch/prazeres/MarcosBandeiraDancarinoeCoreografo(1).jpg';
export { default as MarcosBandeiraDancarinoeCoreografoDois } from './programLaunch/prazeres/MarcosBandeiraDancarinoeCoreografo(2).JPG';
export { default as MarcosBandeiraDancarinoeCoreografoTres } from './programLaunch/prazeres/MarcosBandeiraDancarinoeCoreografo(3).jpg';
export { default as MarcosBandeiraDancarinoeCoreografoQuatro } from './programLaunch/prazeres/MarcosBandeiraDancarinoeCoreografo(4).JPG';
export { default as MarcosBandeiraDancarinoeCoreografoCinco } from './programLaunch/prazeres/MarcosBandeiraDancarinoeCoreografo(5).jpg';

export { default as CharlesSiqueira } from './programLaunch/prazeres/CharlesSiqueiraCoordenadordoPrograma.JPG';
export { default as CrisdosPrazeres } from './programLaunch/prazeres/CrisdosPrazeresInstitutoPrecisaSer.jpg';
export { default as GenivalAndre } from './programLaunch/prazeres/GenivalAndreLiderançaDosPrazeres.JPG';
